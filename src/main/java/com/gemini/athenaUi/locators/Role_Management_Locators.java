...
//    public static By nameList=By.xpath("(//table[@role='grid']//td)[56]");
    ...
    //span[contains(@class,'p-checkbox-icon pi pi-check')]
    ...
    //button//span[text()='Add New']
    //button//span[text()='Create Course']

    //div[contains(@class,'p-overlaypanel-content')]//div//label[2]
    ...
    //tbody[@class='p-datatable-tbody']//td

    //span[text()='permissionType']/preceding-sibling::span

//    public static By permissionDropdown=By.xpath("//span[contains(@class,'pi pi-fw pi-chevron-right')]");


    //span[contains(@class,'pi pi-fw pi-chevron-right')]


    //div[text()='permissions']/following-sibling::input
