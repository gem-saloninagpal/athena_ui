...
import com.gemini.athena.locators.UserDashboard_Locator;
                ...
                switch (courseOption) {
                    case "Course Summary":
                       ...
                       if(heading.equals(fetchedHeading))
                       {
                        ...
                        break;
                    case "Learners Assigned":
                        String heading1="View Learner(s) Report: "+CourseName;
                    ...
                    case "Learner Reports":
                        String heading2="View Learner(s) Reports: "+CourseName;
