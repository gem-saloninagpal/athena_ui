...
//                    }
    ...
    public void updateValuesInAssignment(String tag, String marks) {
        ...
        try {
            ...
            DriverAction.waitUntilElementIsClickable(By.xpath(MyLocators.option.replace("input", tag)));
            //select an option from dropdown
...
//            }
    ...
    public void verifyAssignmentUpdated(String tag, String marks) {
        ...
        try {
            DriverAction.waitUntilElementAppear(MyLocators.assignmentTagDisplayed, 6);
    ...
    public void verifyContentUpdated(String tag, String duration) {
        try {
            DriverAction.waitUntilElementAppear(MyLocators.contentTagDisplayed, 6);
    ...
    public void isDeactivated() {
        try {
            DriverAction.waitUntilElementAppear(MyLocators.inactiveStatusBar, 6);
    ...
    public void clickAddNewButton() throws InterruptedException {
        try {
            DriverAction.waitUntilElementIsClickable(MyLocators.addNewAssignment);
