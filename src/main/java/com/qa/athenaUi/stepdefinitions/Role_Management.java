...
public class Role_Management {
    ...
    public void createRole(String roleName,String roleDesc,String roleDisplay) {
        try {
            DriverAction.click(Role_Management_Locators.createRole);
            DriverAction.typeText(Role_Management_Locators.roleName, roleName);
            DriverAction.typeText(Role_Management_Locators.roleDesc, roleDesc);
            DriverAction.typeText(Role_Management_Locators.roleDisplay, roleDisplay);
            DriverAction.waitSec(2);
            DriverAction.click(Role_Management_Locators.permissionExpand);
            DriverAction.waitUntilElementIsClickable(Role_Management_Locators.permissionCheckbox);
            DriverAction.click(Role_Management_Locators.permissionCheckbox);
            DriverAction.scrollToBottom();
            DriverAction.scrollIntoView(Role_Management_Locators.submit);
            DriverAction.waitSec(2);
            DriverAction.click(Role_Management_Locators.submit);
            GemTestReporter.addTestStep("Created", "Role created", Status.PASS);
        } catch (Exception e) {
...
////            DriverAction.click(By.xpath("//table[@role='table']"));
////            DriverAction.waitSec(4);
//            DriverAction.scrollToBottom();
//            DriverAction.scrollIntoView(By.xpath("//table[@role='table']//tr[last()]//td[last()]"));
////            DriverAction.scrollToBottom();
//            int idx = 0;
...
//we are validating the permission
            ...
            if(testType.equals("Placement Drives")) {
                ...
                System.out.println(Status_placement);
            }
            else if(testType.equals("Internal Tests"))
            {
                String Status_internal = DriverAction.getAttributeName(Role_Management_Locators.StatusInternal, "ng-reflect-disabled");
                if (Status_internal.equals("true")) {
                ...
                System.out.println(Status_internal);
            }
            else
            {
...
//            DriverAction.scrollToBottom();
    ...
    public void editTheRole() {
        try {
            DriverAction.waitSec(3);
            DriverAction.scrollIntoView(Role_Management_Locators.roleTest);
            DriverAction.waitSec(2);
            DriverAction.click(Role_Management_Locators.roleActionsBtn);
            DriverAction.waitUntilElementIsClickable(Role_Management_Locators.editRoleIcon);
            DriverAction.click(Role_Management_Locators.editRoleIcon);
            DriverAction.waitSec(5);
            DriverAction.waitUntilElementIsClickable(Role_Management_Locators.expandManageTests);
            DriverAction.click(Role_Management_Locators.expandManageTests);
            DriverAction.waitSec(3);
            DriverAction.click(Role_Management_Locators.internalTest);
            DriverAction.waitSec(2);
            DriverAction.click(Role_Management_Locators.evaluateCheckbox);
            DriverAction.waitSec(4);
            DriverAction.scrollToBottom();
            DriverAction.waitSec(3);
            DriverAction.scrollIntoView(Role_Management_Locators.submit);
            DriverAction.scrollToBottom();
            DriverAction.click(Role_Management_Locators.submit);
            DriverAction.waitUntilElementAppear(Role_Management_Locators.toastMsg, 20);
            GemTestReporter.addTestStep("Edited", "Role edited successfully", Status.PASS);
        } catch(Exception e) {
            GemTestReporter.addTestStep("Error", "Role not edited" + e, Status.ERR);
        }
    }
