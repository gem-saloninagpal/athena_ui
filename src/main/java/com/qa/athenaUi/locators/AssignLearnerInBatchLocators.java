...
public class AssignLearnerInBatchLocators {
    ...
    public static By assignedLearnerCount=By.xpath("(//span[@class='header-number'])[2]");
    ...
    public static By selectedEC=By.xpath("//span[text()='EC']//parent::td");
    public static By ec = By.xpath("//*[@ng-reflect-label=\"EC\"]");
    public static By qa = By.xpath("//*[@ng-reflect-label=\"QA\"]");
}
