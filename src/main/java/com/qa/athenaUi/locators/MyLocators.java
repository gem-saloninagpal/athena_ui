...
public class MyLocators {
    ...
    public static By signInBtn = By.xpath("//button/span[text()='Sign in']");
    ...
    public static By crossIcon=By.xpath("//button[contains(@class,'close')]/span");
    ...
    public static By signIn=By.xpath("//button[@label='Sign in']");
    public static By allCompletedTests=By.xpath("//p-tabpanel[@header='Completed Tests']//div[contains(@class,'name')]");
    public static By loginPageLink=By.xpath("//a[contains(text(),'Login')]");
