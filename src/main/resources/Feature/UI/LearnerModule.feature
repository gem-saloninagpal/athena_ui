...
@6 @fixed
  Scenario Outline: Create Course->Start Course->Validate Upload assignment file
    ...
    Examples:
      ...
      |Course Library|Manage Courses|Learner|  Public  |  30    |  Java   |C:\Users\saloni.nagpal\Pictures\Screenshots\Screenshot (10).png|Logical |abc        |              |                 |C:\Users\saloni.nagpal\Desktop\Dummy.zip|
