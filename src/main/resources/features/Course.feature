...
Feature:Course module features
  ...
  Scenario Outline: Create Course Verify Owner
    ...
    Examples:
      | module        |submodule     |screen|
      | Manage Courses|Course Library| Course Library |
  ...
  Scenario Outline: Create Course verify Add Assignment
    ...
    And Validate "<category>" on Add Assignment Screen
  ...
  Scenario Outline: Create Course->Edit and verify the course
    ...
    Examples:
      ...
      | Manage Courses|Course Library|Public    |  30    |  Java   | Logical| C:\Users\rahul.adhikari\Pictures\testImage.png|abc        |new assignment-01 |Content successfully added. Add more!|Assignment successfully added. Add more!|Content|Assignment|
              ...
              @6 @course @uptoDate @maintainance
...
@7 @Course @uptodate  @maintainance
  Scenario Outline: Assign Created Course->verify the result once the user complete the course
    ...
    |Learner|Manage Courses|Course Library|rahul|rahul23@gmail.com|100%|Completed|
  ...
  Scenario Outline: Reattempt already completed Course
    ...
    Examples:
      |Role   |  module      |submodule     |Learner|Email|Percentage|Status|
      |Learner|Manage Courses|Course Library|rahul|rahul.adhikari2@gmail.com|100%|Completed|
  ...
  @13 @learnerReport @requireUpdation
  ...
  Scenario Outline:  Filter learner using email->Validate Learner assign count and popup
    ...
    Examples:
      ...
      | Manage Courses       |Course Library  |Assign Learners|course|1    |learner2@gmail.com	|

  @19  @learnerReport @uptodate
  Scenario Outline:  Filter learner using email->Validate Learner Unassign count and popup
    ...
    Examples:
      | module        |submodule     |Learners Assigned|course|count|email|
      | Manage Courses       |Course Library  |Assign Learners|course|0   |learner2@gmail.com	|


  @20  @learnerReport @uptodate
  Scenario Outline:  Filter learner using Category dropdown->Validate Learner assign count and popup
    ...
    Examples:
      | module        |submodule     |Learners Assigned|course|count|
      | Manage Courses       |Course Library  |Assign Learners|course|1   |
...
@21 @uptoDate
  Scenario Outline: Create Course->verify Course Summary->Assign a Learner and update the date of Unattempted course->Validate date is updated successfully
    ...
    Examples:
      ...
      | Manage Courses|Course Library|Public    |  30 |  Java   | Logical| C:\Users\rahul.adhikari\Pictures\testImage.png |abc|new assignment-01 |Content successfully added. Add more!|Assignment successfully added. Add more!|Content|Assignment|learner2@gmail.com|Assign Learners|course|
  ...
  Scenario Outline:  Complete Course->update the date of Completed course->Validate date is not updated successfully
    ...
    Examples:
      ...
      | Manage Courses       |Course Library  |Assign Learners|course|learner2@gmail.com|abc@123|rahul.adhikari2@gmail.com|abc@123|
...
@23 @uptoDate
  ...
  Examples:
      ...
      | Manage Courses|Course Library|Public    |  30 |  Java   | Logical| C:\Users\rahul.adhikari\Pictures\testImage.png |abc|new assignment-01 |Content successfully added. Add more!|Assignment successfully added. Add more!|Content|Assignment|learner2@gmail.com|Assign Learners|course|learner2@gmail.com|abc@123|rahul.adhikari2@gmail.com|abc@123|

  @24 @learnerReport @tobefixed
...
@25 @learnerReport @tobefixed  @maintainance
...
#      @bug  @maintainance
  Scenario Outline:  Upload assigned Candidate
    ...
    Examples:
      | module        |submodule     |Assign Learners|Course|User|filelocation|
      | Manage Courses|Course Library  |Assign Learners|Course|Learner|C:\Users\rahul.adhikari\Downloads\Sample_Candidate_Assignment_assignedUser.xlsx|
...
# @Manual  @maintainance
  Scenario Outline:  Upload Unassigned Candidate
    ...
    Examples:
      ...
      | Manage Courses|Course Library  |Assign Learners|Course|Learner|C:\Users\rahul.adhikari\Downloads\Sample_Candidate_Assignment_UnassignedUser.xlsx|learner2@gmail.com|
#
# @Manual  @maintainance
...
# @Manual  @maintainance
  Scenario Outline:  Upload New Learner
    ...
    Examples:
      | module        |submodule     |Assign Learners|Course|User|filelocation|Learner|
      | Manage Courses|Course Library  |Assign Learners|Course|Learner|C:\Users\rahul.adhikari\Downloads\Sample_Candidate_Assignment_newUser.xlsx|user12@gmail.com|


@new
  Scenario Outline: Create Course verify Has Test
    Given Select "<module>", "<submodule>" from sidebar
    When Click the button "Create Course"
    And Enter respective values in course fields "<courseType>", "<duration>", "<courseTag>", "<fileLocation>", "<category>"
    Then check the Has Test and Validate option appear
    Examples:
      | module        |submodule     |courseType|duration|courseTag|category|fileLocation|
      | Manage Courses|Course Library|Public    |  30 |  Java   | Logical| C:\Users\rahul.adhikari\Pictures\testImage.png |


  @new
  Scenario Outline: Create Course->Verify Has Test->Validate Retake get checked when we check Generate certificate checkbox
    Given Select "<module>", "<submodule>" from sidebar
    When Click the button "Create Course"
    And Enter respective values in course fields "<courseType>", "<duration>", "<courseTag>", "<fileLocation>", "<category>"
    And check the Has Test and Validate option appear
...
#    need to create add test function
@new @needtobeupdate
  Scenario Outline: Create Course->Complete Course
    Given Select "<module>", "<submodule>" from sidebar
    When Click the button until it appear "Create Course"
    And Enter respective values in course fields "<courseType>", "<duration>", "<courseTag>", "<fileLocation>", "<category>"
    And check the Has Test and Validate option appear
    And Validate Automatic selection of Retake checkbox
    And Click the button until it appear "Add Content"
    And Validate "<content>" Add to Course "<contentMessage>"
    And Validate Filter functionality "<assignmentName>"
    And Validate "<category>" on Add Assignment Screen
  ...
  @new
  Scenario Outline: Validate Course Year filter data loaded properly
    Given Switch the user to "<Role>"
    And Validate "<Role>" get updated
    And switch the tab to "<Completed>"
  ...
  Scenario Outline: Validate Allow Retake test functionality
    Given Select "<module>", "<submodule>" from sidebar
    When Click the button until it appear "Create Course"
    And Validate all fields exists in "Add Course Info" section
    And Enter respective values in course fields "<courseType>", "<duration>", "<courseTag>", "<fileLocation>", "<category>"
    And check the Has Test and Validate option appear
    And Click the button until it appear "Add Content"
    And Validate "<content>" Add to Course "<contentMessage>"
    And Click the button until it appear "Add New Test"
    And Validate all fields exists in "Add Test Info" section
    And Add Test Info for Internal Test  "<Duration>", "<level>"
    And Enter Test Description "<Description>"
    And click button "Next"
    And Verify if all fields exist in "Select Options Internal Training" section
    And Select option for internal Test
    And Verify if all fields exist in "Add Sections Internal Training" section
    And Add Section "<Section>", "<Percentage>", "<Duration>"
    And Click the button "Add"
    ...
    And Assign a Learner to the Course
    And Change the user's role "<Role>"
    And Complete the course and "<testStatus>" the test when retake button is "<checked>"
    And Validate certificate after completion of course when user "<testStatus>" and option is "<checked>"
    And Switched to completed course section and validate view or download button functionality "<testStatus>" "<certificateChecked>"
    Then validate course summary screen for Retake button "<testStatus>" "<retakeChecked>"

    Examples:
      | module        |submodule     |courseType|duration|courseTag|category|fileLocation                                    |contentMessage                       |content|level    |Description|Section | Percentage |Duration|Role|testStatus|checked|certificateChecked|retakeChecked|
      | Manage Courses|Course Library|Public    |  30    |  Java   | Logical| C:\Users\rahul.adhikari\Pictures\testImage.png |Content successfully added. Add more!|Content| Beginner|abc        |Logical | 5          |00:30   |Learner|Fail|True|True|True|
      | Manage Courses|Course Library|Public    |  30    |  Java   | Logical| C:\Users\rahul.adhikari\Pictures\testImage.png |Content successfully added. Add more!|Content| Beginner|abc        |Logical | 5          |00:30   |Learner|Pass|True|True|True|
      | Manage Courses|Course Library|Public    |  30    |  Java   | Logical| C:\Users\rahul.adhikari\Pictures\testImage.png |Content successfully added. Add more!|Content| Beginner|abc        |Logical | 5          |00:30   |Learner|Pass|False|False|False|
