Feature:UserDashboard Module features
  ...
  Scenario Outline: Create Course->Assigned Learner->Validate Assigned Learner in UserDashboard
    ...
    Examples:
      | module        |submodule     |courseType|duration|category|fileLocation|description|assignmentName|contentMessage|assignmentMessage|module1|submodule1|
      | Manage Courses|Course Library|Public    |  30  | Logical| C:\Users\rahul.adhikari\Pictures\testImage.jpg |abc|new assignment-01 |Content successfully added. Add more!|Assignment successfully added. Add more!|User Dashboard||
...
#    please correct the edit
  ...
  Scenario Outline: Create Course->Publish course->Validate Course Summary on User Dashboard
    ...
    Examples:
      | module        |submodule     |courseType|duration|category|fileLocation|description|assignmentName|contentMessage|assignmentMessage|module1|submodule1|Course|
      | Manage Courses|Course Library|Public    |  30  | Logical| C:\Users\rahul.adhikari\Pictures\testImage.jpg |abc|new assignment-01 |Content successfully added. Add more!|Assignment successfully added. Add more!|User Dashboard||Course Summary|
  ...
  Scenario Outline: Create Course->Publish course->Validate Learner Assigned on User Dashboard
    ...
    Examples:
      | module        |submodule     |courseType|duration|category|fileLocation|description|assignmentName|contentMessage|assignmentMessage|module1|submodule1|Course|
      | Manage Courses|Course Library|Public    |  30  | Logical| C:\Users\rahul.adhikari\Pictures\testImage.jpg |abc|new assignment-01 |Content successfully added. Add more!|Assignment successfully added. Add more!|User Dashboard||Learners Assigned|
  ...
  Scenario Outline: Create Course->Publish course->Validate Learner Report on User Dashboard
    ...
    Examples:
      | module        |submodule     |courseType|duration|category|fileLocation|description|assignmentName|contentMessage|assignmentMessage|module1|submodule1|Course|
      | Manage Courses|Course Library|Public    |  30  | Logical| C:\Users\rahul.adhikari\Pictures\testImage.jpg |abc|new assignment-01 |Content successfully added. Add more!|Assignment successfully added. Add more!|User Dashboard||Learner Reports|
  ...
  Scenario Outline: Create Course->Publish course->Validate Edit Course on User Dashboard
    ...
    Examples:
      | module        |submodule     |courseType|duration|category|fileLocation|description|assignmentName|contentMessage|assignmentMessage|module1|submodule1|Course|
      | Manage Courses|Course Library|Public    |  30  | Logical| C:\Users\rahul.adhikari\Pictures\testImage.jpg |abc|new assignment-01 |Content successfully added. Add more!|Assignment successfully added. Add more!|User Dashboard||Edit|
