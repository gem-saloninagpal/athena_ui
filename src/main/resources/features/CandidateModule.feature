Feature: Candidate module features
  ...
  Background:Check login to candidate module
    And Navigate to page "login"
    Then Login using "latestcandidate@gmail.com" and "abc@123"
  ...
  Scenario Outline: Login flow for Candidate
    ...
    Then Verify the email of candidate "latestcandidate@gmail.com"
  ...
  @regressionCandidate @working @fail
  ...
  @regressionCandidate @working @fixed
  ...
  @regressionCandidate @lastStepToBeUpdated @fixed
  ...
  @regressionCandidate @working @fixed @fail
  Scenario Outline: Validate password errors
    And Expand info dropdown from navbar
    Then Verify the options present in dropdown "<option1>", "<option2>", "<option3>"
    When select option "Change Password" from dropdown
    ...
    When Enter a password "abc@1234" in new password field
    And Enter a password in confirm password field "abc@1234", "Confirm Password"
