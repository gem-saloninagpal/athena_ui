Feature: L&D Athena
    ...
    Scenario Outline: Register Role- Learner, Admin, Invigilator, Super Admin
      ...
      |User Management|Register|User Management|required|Invigilator  |Employees|already exist|1  |
      |User Management|Register|User Management|required|Super Admin  |Employees|already exist|1  |
  ...
  @regression
          Scenario Outline: Verify active/inactive user
            ...
            Then Select Actions icon of first record displayed in Employees
            And Select Edit Profile option
            Then Verify user is navigated to page "<module>"
  ...
  @regression
          ...
          Scenario Outline: Login flow for Candidate
            Given Logout of portal
            And Login using "testing1@gmail.com" and "abc@123"
            ...
            Then Verify the email of candidate "abcdef@gmail.com"
            ...
            Scenario Outline: Verify the default tab selected and number of tests assigned
              Given Logout of portal
              And Login using "test1@hotmail.com" and "abc@123"
              Then Verify Candidate is logged in
