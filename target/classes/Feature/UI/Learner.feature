Feature: Learner module features
  ...
  Scenario Outline: Create Course->Assign Learner->Start Course and navigate back->Course Resume text Validation
    ...
    Then Create a Course for Learner "<courseType>", "<duration>", "<points>", "<courseTag>", "<fileLocation>", "<category>", "<description>", "<contentMessage>", "<assignmentMessage>"
  ...
  Scenario Outline: Create Course->Start Course->Validate View Upload file
    ...
    Examples:
      |submodule|module|option1|courseType|duration|courseTag|fileLocation                                    |category|description|contentMessage|assignmentMessage                               |fileLocation1                       |points|
      |Course Library|Manage Courses|Learner|  Public  |  30    |  Java   | C:\Users\saloni.nagpal\Pictures\Screenshots\Screenshot (10).png|Logical |abc        |              |                 |C:\Users\saloni.nagpal\Desktop\Dummy.zip|10  |
