Feature:Content and Assignment features
  ...
  @regression
    Scenario Outline:Create content- positive flow
     ...
     | Manage Courses|Content Library| Java      |Image (.jpg .jpeg .png)   |01:00   |C:\Users\Pallavi.Arora\Downloads\athena.png|testAbc    |
  ...
  @regression
     Scenario Outline:Reset content
      ...
      | Manage Courses|Content Library| Java      |Image (.jpg .jpeg .png)   |01:00   |C:\Users\Pallavi.Arora\Downloads\athena.png|testAbc    |This Field is required|6                  |
  ...
  @regression
     Scenario Outline:Create assignment- positive flow
       ...
       |Manage Courses|Assignment Library| Java        | 10  |  01:00 | Logical| C:\Users\Pallavi.Arora\Downloads\athena.png |abc        |
