  ...
  @regression @bugEncountered
       ...
       #     When Switch to tab "<tab>", "<index>"
            ...
            Examples:
              ...
              |User Management|Gemini Users|1      |User Management / Update User|         |

#  @regression
#          Scenario Outline: Change role and validate
#            Given Select "<module>", "<submodule>" from sidebar
#            When Switch to tab "<tab>", "<index>"
#            And Search a user "rahul.adhikari"
#            And Select Actions icon of first record displayed in Employees
#            And Select Edit Profile option
#            Then Verify user is navigated to page "<string1>"
#            And Enable editing
...
#              |User Management|Gemini Users|1      |Learner|Super Admin|Admin   |User Management / Update User|         |
  ...
  @regression @working
          Scenario Outline: View learner's report
            Given Select "<module>", "<submodule>" from sidebar
            And Search a learner "saloni.nagpal@geminisolutions.com"
